<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评价" prop="pingjia">
          <el-input v-model="ruleForm.pingjia" 
              placeholder="评价" clearable  :readonly="ro.pingjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评价" prop="pingjia">
              <el-input v-model="ruleForm.pingjia" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="部分内容" prop="bufenneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.bufenneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bufenneirong" label="部分内容" prop="bufenneirong">
                    <span v-html="ruleForm.bufenneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shujifenlei = true;
          ...
          if(o=='bufenneirong'){
            this.ruleForm.bufenneirong = obj[o];
	    this.ro.bufenneirong = true;
            continue;
          }
          if(o=='zuozhe'){
	...
	this.ruleForm.bufenneirong = this.ruleForm.bufenneirong.replace(reg,'../../../ssmz87c4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
